...
def read_pkl(input_path: str, description: str = "") -> TestCase:
...
if __name__ == "__main__":
    case = read_pkl("examples/2D_points/0", "20 2D points generated by util/2dgenerator_with_true")
    ecm = ECM(distance_threshold=10)
    results = test_2d(ecm, case, False, False)
