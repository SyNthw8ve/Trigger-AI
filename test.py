...
def train(gng: GNG):
    ...
    environment_train = GNGParameterEnvironment(gng)
    environment_eval = GNGParameterEnvironment(gng)
    train_env = tf_py_environment.TFPyEnvironment(environment_train)
