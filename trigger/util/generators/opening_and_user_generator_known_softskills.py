...
from ..readers.data_reader import DataReaderOpenings, DataReaderUsers
import os
import random
...
set_ss = {'Teamwork', 'Leadership', 'Resilience', 'Emotional Intelligence',
          'Communication', 'Proactivity', 'Ethics', 'Complex Thinking'}
...
hs_map = {
    "Archaeology": ["Archaeology", "History", "Biology"],
    "Security": ["Military Training"],
    "Military": ["Military Training", "Mechanical Engineering"],
    "Environment": ["Law", "Environment", "Mechanical Engineering"],
    "Law": hs_law,
    ...
    "Bank": ["Math", "Money", "Finances"],
    "Art": ["Art", "Color theory"],
    "Market Study": ["Sociology", "Finances"],
    "Gastronomy": ["Gastronomy"],
    "Construction": ["Construction", "Painting", "Soldering", "Architecture"],
...
it = [("Complex Thinking", 70), ("Teamwork", 20),
      ("Resilience", 30), ("Teamwork", 70), ("Communication", 40), ("Proactivity", 50)]

law = [("Complex Thinking", 70), ("Ethics", 40),
       ("Communication", 70), ("Emotional Intelligence", 40), ("Resilience", 30)]

accounting = [("Complex Thinking", 60), ("Teamwork", 30),
              ("Resilience", 40), ("Leadership", 50)]

art = [("Proactivity", 90), ("Emotional Intelligence", 40),
       ("Teamwork", 40), ("Communication", 40), ("Complex Thinking", 20)]

marketing = [("Ethics", 50), ("Leadership", 50),
             ("Communication", 50), ("Complex Thinking", 50), ("Teamwork", 30)]

ss_map = {
    "Archaeology": [("Leadership", 30), ("Communication", 30), ("Proactivity", 80)],
    "Security": [("Resilience", 55), ("Ethics", 30), ("Proactivity", 50), ("Communication", 70)],
    "Military": [("Leadership", 50), ("Teamwork", 10), ("Proactivity", 50), ("Complex Thinking", 50)],
    "Environment": [("Resilience", 50), ("Ethics", 40), ("Emotional Intelligence", 40)],
    "Management": [("Complex Thinking", 50), ("Teamwork", 40), ("Communication", 60), ("Emotional Intelligence", 30), ("Leadership", 40)],
    "Operations": [("Complex Thinking", 60), ("Resilience", 50), ("Communication", 30), ("Leadership", 20)],
    "Production": [("Complex Thinking", 50), ("Resilience", 60), ("Communication", 20), ("Leadership", 30)],
    "Logistics": [("Complex Thinking", 75), ("Resilience", 50), ("Communication", 20), ("Leadership", 10)],
    "Research & Development": [("Proactivity", 50), ("Ethics", 70), ("Complex Thinking", 60), ("Communication", 60)],
    "Sales": [("Communication", 90), ("Emotional Intelligence", 70), ("Proactivity", 40), ("Teamwork", 30), ("Leadership", 10)],
    "Marketing": marketing,
    "Administration": [("Complex Thinking", 30), ("Communication", 70), ("Emotional Intelligence", 60), ("Leadership", 50)],
    "Legal": law,
    "Law": law,
    "Finance & Accounting": accounting,
    "Accounting": accounting,
    "Human Interaction": [("Emotional Intelligence", 20), ("Complex Thinking", 90), ("Ethics", 40)],
    "Human Resources": [("Complex Thinking", 70), ("Communication", 40), ("Ethics", 70)],
    ...
    "Gastronomy":  [("Proactivity", 90), ("Communication", 50)],
    "Design": [("Teamwork", 50), ("Communication", 70), ("Emotional Intelligence", 50), ("Proactivity", 40)],
    "Public Relation": [("Communication", 90), ("Leadership", 40), ("Teamwork", 40), ("Emotional Intelligence", 70)],
    "Construction": [("Ethics", 70), ("Proactivity", 70), ("Resilience", 70)],
    "Psychology": [("Communication", 90), ("Ethics", 70), ("Emotional Intelligence", 80), ("Proactivity", 40)],
    "Medicine": [("Communication", 40), ("Complex Thinking", 90), ("Emotional Intelligence", 50), ("Resilience", 70), ("Teamwork", 30)],
    "Agriculture": [("Ethics", 50), ("Proactivity", 60), ("Resilience", 70)],
}

base = r"data/names.txt"
base_ = os.path.join(Path('..').absolute(), base)
