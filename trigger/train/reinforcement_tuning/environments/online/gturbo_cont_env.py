...
class OnlineTurboContinuousEnvironment(py_environment.PyEnvironment):
    ...
    def add_to_environment(self, instance):

        self._state.turbo_step(instance)
    ...
    def _step(self, action):
        ...
        before_action_metrics = eval_cluster(self._state)

        self.Sst = before_action_metrics['ss']
        self.CHst = before_action_metrics['chs']
