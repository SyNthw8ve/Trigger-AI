...
class GStream:
    ...
    def __init__(self, vector_size, alpha1, alpha2, beta, error_decrease):
        ...
        node_1 = Node(np.random.rand(vector_size, 1), 0, 0)
        node_2 = Node(np.random.rand(vector_size, 1), 0, 0)
    ...
    def cluster(self, instance, bmu1, bmu2):
        ...
        bmu1.error += np.pow(cdist(bmu1.protype, instance), 2)
